    ...
    return function(scope, element, attrs) {
      ...
      scope.$on('loc',function(event,data){
          ...
          if(data.succeed == 1){
            ...
            input.placeholder='Promenite lokaciju';
            ...
            var input = document.getElementById('pac-input');
            input.placeholder='Lociranje nije uspelo, izaberite lokaciju';
          }
      ...
      scope.$on('all', function(event, data) {
        ...
        scope.$on('one', function(event, data) {
            ...
            createMarker(loc, 'Trazeni objekat');
      });
